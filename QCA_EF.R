...
dataNR <- superSubset(data, outcome = "EF", incl.cut = 0.9, cov.cut = 0.52)
dataNR
...
# trthTable
TT<-truthTable(data, outcome = "EF", show.cases = TRUE, sort.by = c("incl", "n"))
TT

TT <- truthTable(data, outcome = c("EF"), neg.out = FALSE, conditions = c("FMC", "ECG","TXF", "TWT"),
